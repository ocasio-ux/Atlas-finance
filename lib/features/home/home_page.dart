...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _openNewTransaction() async => Navigator.of(
    context,
  ...
  Future<void> _openAccountsAndCards() async => Navigator.of(
    context,
  ).push<void>(MaterialPageRoute(builder: (_) => const AccountsCardsPage()));
  Future<void> _openHistory() async => Navigator.of(context).push<void>(
        ...
        child: ListView(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: _MoneyCard(
                    title: 'Receitas',
                    value: CurrencyFormatter.brl(store.income),
                ...
                Expanded(
                  child: _MoneyCard(
                    title: 'Despesas',
                    value: CurrencyFormatter.brl(store.expenses),
            ...
            _SectionTitle(
              ...
              action: 'Gerenciar',
              onTap: _openAccountsAndCards,
            ),
            const SizedBox(height: 12),
            _AccountsShortcut(onTap: _openAccountsAndCards),
            const SizedBox(height: 28),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          title,
          style: const TextStyle(color: AtlasColors.textMuted, fontSize: 13),
        ),
    ...
    child: Container(
      ...
      child: const Row(
        children: [
          CircleAvatar(
            radius: 22,
            backgroundColor: Color(0x2912B879),
            child: Icon(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  'Cadastre contas, carteiras e cartões.',
                  style: TextStyle(color: AtlasColors.textMuted, fontSize: 13),
                ),
              ],
            ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Converse com o Atlas sobre suas finanças.',
                style: TextStyle(color: Color(0xFFE2FFF1), fontSize: 13),
              ),
            ],
          ),
        ),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: const Column(
      children: [
        ...
        SizedBox(height: 4),
        Text(
          'Toque em Adicionar para registrar a primeira.',
