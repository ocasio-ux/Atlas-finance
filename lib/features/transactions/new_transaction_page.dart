...
class _NewTransactionPageState extends State<NewTransactionPage> {
  ...
  Future<void> _save() async {
    ...
    await TransactionStore.instance.add(
      AtlasTransaction(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Nova movimentação', style: TextStyle(fontWeight: FontWeight.w700)),
      ),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                prefixText: 'R\$ ',
                prefixStyle: TextStyle(color: AtlasColors.white, fontSize: 38, fontWeight: FontWeight.w700),
                hintText: '0,00',
            ...
            const _OptionTile(icon: Icons.category_outlined, title: 'Categoria', subtitle: 'Disponível em breve'),
            const SizedBox(height: 12),
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                label: Text(saving ? 'Salvando...' : 'Salvar movimentação', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          child: Column(children: [
            ...
            Text(label, style: TextStyle(color: selected ? AtlasColors.white : AtlasColors.textMuted, fontSize: 12, fontWeight: selected ? FontWeight.w700 : FontWeight.w500)),
          ]),
        ),
      ),
    );
...
class _AtlasField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(labelText: label, hintText: hint, prefixIcon: Icon(icon, color: AtlasColors.green)),
    );
  }
}
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          width: 42,
          height: 42,
          decoration: BoxDecoration(color: AtlasColors.green.withValues(alpha: 0.18), borderRadius: BorderRadius.circular(13)),
